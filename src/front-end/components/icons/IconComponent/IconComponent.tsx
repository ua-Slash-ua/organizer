...
export default function IconComponent({
    ...
    switch (element) {
        case 'a':
            return <Link href={href} className={clsx(s.container, className)} onClick={onChangeAction}>
                <Image src={src} alt={alt} width={1000} height={1000} className={s.image}/>
            </Link>
        case 'div':
            return <div className={clsx(s.container, className)} onClick={onChangeAction}>
                <Image src={src} alt={alt} width={1000} height={1000} className={s.image}/>
            </div>
        default:
